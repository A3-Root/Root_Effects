...
private _tip_fulger = selectRandom ["A3\data_f\blesk1","A3\data_f\blesk2"];
private _tunet = selectRandom ["05_far","06_far","08_far","14_far","21_far","26_far"];

private _sclipiri = floor (random 5);
drop [[_tip_fulger,1,0,1],"","SpaceObject",1,0.2,_this,[0,0,0],0,10,7.9,0,[3],[[1,1,1,1]],[1],0,0,"","",_this];
while {_sclipiri>0} do 
{
	private _li_fulger = "#lightpoint" createVehicle _this;
	_li_fulger setLightAttenuation [0,0,0,0,40,10000];
	private _brit = 50+(random 150);
