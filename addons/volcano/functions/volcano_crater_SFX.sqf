...
private _interior_lava = "#particlesource" createVehicleLocal getPosATL _volcano_object;
...
private _lava_heat = "#particlesource" createVehicleLocal getPosATL _volcano_object;
...
private _lava = "#particlesource" createVehicleLocal position _volcano_object;
...
private _lava_chunks = "#particlesource" createVehicleLocal position _volcano_object;
...
private _lava_boil = "#particlesource" createVehicleLocal position _volcano_object;
