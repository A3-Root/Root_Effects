...
private _volcano_object	= _this select 0;

private _curgere_lava = "#particlesource" createVehicleLocal [(getPosATL _volcano_object select 0) + random(25), (getPosATL _volcano_object select 1) + random(25), (getPosATL _volcano_object select 2) + random(25)];
...
private _curgere_lava_1 = "#particlesource" createVehicleLocal [(getPosATL _volcano_object select 0) + random(25), (getPosATL _volcano_object select 1) + random(25), (getPosATL _volcano_object select 2) + random(25)];
...
private _curgere_lava_2 = "#particlesource" createVehicleLocal [(getPosATL _volcano_object select 0) + random(25), (getPosATL _volcano_object select 1) + random(25), (getPosATL _volcano_object select 2) + random(25)];
