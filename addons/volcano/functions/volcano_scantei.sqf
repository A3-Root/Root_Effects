...
private _blow_up = "#particlesource" createVehicleLocal position _alias_volcano;
...
private _lava_chunks = "#particlesource" createVehicleLocal position _alias_volcano;
