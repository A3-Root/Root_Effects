...
[LLSTRING(ModuleLightning), [
    ...
    _results params ["_radius", "_duration", "_minInterval", "_maxInterval", "_damage", "_ambience"];

    [QGVAR(startLightning), [_pos, _radius, _duration, _minInterval, _maxInterval, _damage, _ambience]] call CBA_fnc_serverEvent;
