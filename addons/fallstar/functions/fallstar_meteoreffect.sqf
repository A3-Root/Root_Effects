...
private _fall_meteor_smoke = _this select 0;

private _li2 = "#lightpoint" createVehicle getPos _fall_meteor_smoke;
...
private _meteor_smoke  = "#particlesource" createVehicleLocal getPosATL _fall_meteor_smoke;
...
private _ps2 = "#particlesource" createVehicleLocal getPosATL _fall_meteor_smoke;
