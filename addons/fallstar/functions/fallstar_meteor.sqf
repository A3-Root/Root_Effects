...
private _dire	= selectRandom [1000, -1000];
...
private _falling_meteor_main = "Land_Battery_F" createVehicle _poz_ini;
...
private _bariera_sunet = selectRandom ["bariera_1","bariera_2","bariera_3","bariera_4", "bariera_5"];	
[_falling_meteor_main,[_bariera_sunet,4000]] remoteExec ["say3D"];

private _dire_dest	= selectRandom [1000, -1000];	
...
private _poz_end = getPos _falling_meteor_main;
...
private _nearobjects = nearestObjects[_poz_end,[],100];
{
