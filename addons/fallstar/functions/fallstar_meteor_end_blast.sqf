...
params ["_poz","_xv","_yv","_shk"];
private ["_blast","_blast_wave"];

private _splash_hot = "#particlesource" createVehicleLocal _poz;
...
private _bolovani = "#particlesource" createVehicleLocal _poz;
...
private _fum = "#particlesource" createVehicleLocal _poz;
...
private _meteor_voice = "land_helipadempty_f" createVehicleLocal _poz;

[_meteor_voice] spawn {
	private ["_meteor_voice"];
	_meteor_voice = _this select 0;
	private _delay_m = linearConversion [0,2000,player distance _meteor_voice,0,1,true];
	private _pow_met = linearConversion [0,2000,player distance _meteor_voice,6,0.1,true];
	uiSleep _delay_m;
