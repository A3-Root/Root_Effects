...
/*
Falling stars	
	[_cometFrequency] execvm "\Root_Effects\Root_Fallstar\ALfallstar\alias_fallingstarIni.sqf"; - at every X seconds a falling star will be generated
	
Meteors
	[_meterFrequency] execvm "\Root_Effects\Root_Fallstar\ALfallstar\alias_meteorIni.sqf"; - at every X seconds a meteor will be generated
*/
...
["Meteors and Comet Settings",[
	...
	["SLIDER",["Comet Frequency","Frequency in seconds of how often the phenomena takes place."],[10,600,30,0]]
		...
		if (_isMeteor) then { [_meteorFrequency] remoteExec [QFUNC(startMeteorSpawner), 2]; };
		if (_isComet) then { [_cometFrequency] remoteExec [QFUNC(startCometSpawner), 2]; };
