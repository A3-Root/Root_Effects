...
[{
    ...
    private _color = selectRandom [[1, 0.3, 0.2], [0.3, 1, 0.3], [0.4, 0.6, 1], [1, 0.85, 0.4], [1, 1, 1], [1, 0.4, 1]];
    ...
    [{
        ...
        _climbArgs params ["_rocketLight", "_climb", "_stepsLeft"];
    ...
    }, 0.1, [_rocketLight, _climb, ceil (_flightTime * 10)]] call CBA_fnc_addPerFrameHandler;

    [FUNC(fireworkBurstLocal), [_burstPos, _color, _sounds], _flightTime] call CBA_fnc_waitAndExecute;
