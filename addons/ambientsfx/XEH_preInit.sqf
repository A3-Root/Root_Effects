...
["aurora", LLSTRING(ModuleAurora), QGVAR(enabledAurora)] call EFUNC(main,registerEffect);
["rupture", LLSTRING(ModuleRupture), QGVAR(enabledRupture)] call EFUNC(main,registerEffect);
