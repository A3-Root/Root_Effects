 ...
 *
 * Arguments:
 * 0: Instance rows [effectKey, displayName, anchor, grid, elapsedSeconds] <ARRAY>
 *
 * Return Value:
 * None
 *
 * Example:
 * [[["volcano", "Volcano Eruption", _anchor, "045012", 60]]] call root_effects_main_fnc_terminateDialog
 */
...
private _seenKeys = [];
{
    _x params ["_effectKey", "_displayName", "_anchor", "_grid", "_elapsed"];
